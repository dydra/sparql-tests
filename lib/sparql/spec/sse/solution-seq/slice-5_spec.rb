...
# Slice 5
# 
# /Users/ben/repos/datagraph/tests/tests/data-r2/solution-seq/slice-24.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#slice-5
#
...
:x :str  "" .
    ...
    example "Slice 5" do
      ...
      repository = 'solution-seq-slice-5'
      expected = [
          { 
