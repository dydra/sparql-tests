...
# /Users/ben/repos/datagraph/tests/tests/data-r2/open-world/open-eq-02.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#open-eq-02
#
...
:z4 :p "02"^^xsd:integer .
      ...
      @query = %q{
        (prefix ((t: <http://example/t#>)
                 (: <http://example/ns#>))
          (bgp (triple ?x :p "a"^^t:type1)))
}
    end

    example "open-eq-02" do
