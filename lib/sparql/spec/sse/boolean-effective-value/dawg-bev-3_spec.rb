...
# /Users/ben/repos/datagraph/tests/tests/data-r2/boolean-effective-value/query-bev-3.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-bev-3
#
...
:y4 :p    "false"^^xsd:boolean .
    ...
    example "Test 'boolean effective value' - &&" do
      ...
      repository = 'boolean-effective-value-dawg-bev-3'
      expected = [
          { 
