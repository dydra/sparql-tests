...
# isURI-1
# 
# /Users/ben/repos/datagraph/tests/tests/data-r2/expr-builtin/q-uri-1.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-isURI-1
#
...
:xb :p  _:a .
  ...
  (project (?x ?v)
    ...
    example "isURI-1" do
      ...
      repository = 'expr-builtin-dawg-isURI-1'
      expected = [
          { 
