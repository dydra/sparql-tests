...
# Basic - Term 1
# 
# /Users/ben/repos/datagraph/tests/tests/data-r2/basic/term-1.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#term-1
#
...
:x :n4 "-18"^^xsd:integer .
    ...
    example "Basic - Term 1" do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'basic-term-1'
      expected = [
          { 
