...
# /Users/ben/repos/datagraph/tests/tests/data-r2/expr-equals/query-eq-graph-5.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#eq-graph-5
#
...
#:xb :p  _:a .
    ...
    example "Equality 1-5 -- graph" do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'expr-equals-eq-graph-5'
      expected = [
          { 
