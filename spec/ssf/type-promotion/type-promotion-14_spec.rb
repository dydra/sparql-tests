...
# /Users/ben/repos/datagraph/tests/tests/data-r2/type-promotion/tP-nonNegativeInteger-short.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#type-promotion-14
#
 ...
 t:integer1		rdf:value	"1"^^xsd:integer .
  ...
  t:nonNegativeInteger1	rdf:value	"1"^^xsd:nonNegativeInteger .
   ...
   t:positiveInteger1	rdf:value	"1"^^xsd:positiveInteger .
      ...
      @query = %q{
(ask ()
  (filter (= (datatype (+ ?l ?r)) <http://www.w3.org/2001/XMLSchema#integer>)
    (bgp
      (triple <http://www.w3.org/2001/sw/DataAccess/tests/data/TypePromotion/tP-0#nonNegativeInteger1> <http://www.w3.org/1999/02/22-rdf-syntax-ns#value> ?l)
      (triple <http://www.w3.org/2001/sw/DataAccess/tests/data/TypePromotion/tP-0#short1> <http://www.w3.org/1999/02/22-rdf-syntax-ns#value> ?r)
    )))

}
    end

    example "tP-nonNegativeInteger-short" do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'type-promotion-type-promotion-14'
      expected = true
