...
# /Users/ben/repos/datagraph/tests/tests/data-r2/type-promotion/tP-double-double.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#type-promotion-01
#
...
(ask ()
  (filter (= (datatype (+ ?l ?r)) <http://www.w3.org/2001/XMLSchema#double>)
    (bgp
      ...
      (triple <http://www.w3.org/2001/sw/DataAccess/tests/data/TypePromotion/tP-0#double1> <http://www.w3.org/1999/02/22-rdf-syntax-ns#value> ?r)
    )))

}
    end

    example "tP-double-double" do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'type-promotion-type-promotion-01'
      result = true
