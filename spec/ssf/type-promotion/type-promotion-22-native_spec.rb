...
# /Users/ben/repos/datagraph/tests/tests/data-r2/type-promotion/tP-short-decimal.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#type-promotion-22
#
...
(ask ()
  (filter (= (datatype (+ ?l ?r)) <http://www.w3.org/2001/XMLSchema#integer>)
    ...
    example "tP-short-decimal", :arithmetic => 'native' do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'type-promotion-type-promotion-22'
      expected = true
