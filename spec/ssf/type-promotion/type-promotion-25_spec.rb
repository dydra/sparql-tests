...
# /Users/ben/repos/datagraph/tests/tests/data-r2/type-promotion/tP-short-long-fail.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#type-promotion-25
#
...
(ask ()
  (filter (= (datatype (+ ?l ?r)) <http://www.w3.org/2001/XMLSchema#decimal>)
    (bgp
      ...
      (triple <http://www.w3.org/2001/sw/DataAccess/tests/data/TypePromotion/tP-0#long1> <http://www.w3.org/1999/02/22-rdf-syntax-ns#value> ?r)
    )))

}
    end

    example "tP-short-long-fail" do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'type-promotion-type-promotion-25'
      result = false
