...
# /Users/ben/repos/datagraph/tests/tests/data-r2/type-promotion/tP-double-float-fail.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#type-promotion-28
#
 ...
 t:integer1		rdf:value	"1"^^xsd:integer .
  ...
  t:nonNegativeInteger1	rdf:value	"1"^^xsd:nonNegativeInteger .
   ...
   t:positiveInteger1	rdf:value	"1"^^xsd:positiveInteger .
      ...
      @query = %q{
(ask ()
  (filter (= (datatype (+ ?l ?r)) <http://www.w3.org/2001/XMLSchema#float>)
    (bgp
      (triple <http://www.w3.org/2001/sw/DataAccess/tests/data/TypePromotion/tP-0#double1> <http://www.w3.org/1999/02/22-rdf-syntax-ns#value> ?l)
      (triple <http://www.w3.org/2001/sw/DataAccess/tests/data/TypePromotion/tP-0#float1> <http://www.w3.org/1999/02/22-rdf-syntax-ns#value> ?r)
    )))

}
    end

    example "tP-double-float-fail" do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'type-promotion-type-promotion-28'
      expected = false
