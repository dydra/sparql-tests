...
# /Users/ben/repos/datagraph/tests/tests/data-r2/type-promotion/tP-short-byte-fail.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#type-promotion-27
#
 ...
 t:integer1		rdf:value	"1"^^xsd:integer .
  ...
  t:nonNegativeInteger1	rdf:value	"1"^^xsd:nonNegativeInteger .
   ...
   t:positiveInteger1	rdf:value	"1"^^xsd:positiveInteger .
      ...
      @query = %q{
(ask ()
  (filter (= (datatype (+ ?l ?r)) <http://www.w3.org/2001/XMLSchema#double>)
    (bgp
      ...
      (triple <http://www.w3.org/2001/sw/DataAccess/tests/data/TypePromotion/tP-0#byte1> <http://www.w3.org/1999/02/22-rdf-syntax-ns#value> ?r)
    )))

}
    end

    example "tP-short-byte-fail" do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'type-promotion-type-promotion-27'
      expected = false
