...
# /Users/ben/repos/datagraph/tests/tests/data-r2/type-promotion/tP-negativeInteger-short.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#type-promotion-09
#
...
(ask ()
  (filter (= (datatype (+ ?l ?r)) <http://www.w3.org/2001/XMLSchema#integer>)
    (bgp
      (triple <http://www.w3.org/2001/sw/DataAccess/tests/data/TypePromotion/tP-0#negativeIntegerN1> <http://www.w3.org/1999/02/22-rdf-syntax-ns#value> ?l)
    ...
    example "tP-negativeInteger-short" do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'type-promotion-type-promotion-09'
      result = true
