...
# Basic - Term 7
# 
# /Users/ben/repos/datagraph/tests/tests/data-r2/basic/term-7.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#term-7
#
...
:x :n4 "-18"^^xsd:integer .
      ...
      @query = %q{
(select (?p)
        (bgp (triple <http://example.org/ns#x> ?p 456.)))

}
    end

    example "Basic - Term 7" do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'basic-term-7'
      expected = [
          { 
