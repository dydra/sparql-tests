...
# Basic - Prefix/Base 1
# 
# /Users/ben/repos/datagraph/tests/tests/data-r2/basic/base-prefix-1.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#base-prefix-1
#
...
z:x z:p   "z:x z:p" .
      ...
      @query = %q{
(select (?p ?v)
  (bgp (triple <http://example.org/x/x> ?p ?v)))

}
    end

    example "Basic - Prefix/Base 1" do
