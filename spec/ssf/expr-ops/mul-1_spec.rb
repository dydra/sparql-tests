...
# /Users/ben/repos/datagraph/tests/tests/data-r2/expr-ops/query-mul-1.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#mul-1
#
  ...
  (project (?s)
    (filter (= (* ?o ?o2) 4)
      (bgp
        ...
        (triple ?s2 <http://example.org/p> ?o2)
      ))))
