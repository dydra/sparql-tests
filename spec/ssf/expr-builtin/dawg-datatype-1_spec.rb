...
# datatype-1
# 
# /Users/ben/repos/datagraph/tests/tests/data-r2/expr-builtin/q-datatype-1.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-datatype-1
#
...
(select (?x ?v)
  (project (?x ?v)
    (filter (= (datatype ?v) <http://www.w3.org/2001/XMLSchema#double>)
      (bgp (triple ?x <http://example.org/things#p> ?v)))))

}
    end

    example "datatype-1" do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'expr-builtin-dawg-datatype-1'
      expected = [
          { 
          ...
          { 
              :v => RDF::Literal.new('1.0' , :datatype => RDF::URI('http://www.w3.org/2001/XMLSchema#double')),
