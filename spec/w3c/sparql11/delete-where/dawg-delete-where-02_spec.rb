...
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/delete-where/delete-where-02.ru
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-delete-where-02
#
...
DELETE WHERE 
{
  GRAPH <http://example.org/g1> { :a foaf:knows ?b }
    ...
    example "Simple DELETE WHERE 2", :status => 'unverified', :w3c_status => 'unapproved' do
      ...
      repository = 'delete-where-dawg-delete-where-02'
      expected = [
          { 
