...
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/delete-where/delete-where-05.ru
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-delete-where-05
#
...
{ 
  ?a foaf:knows :b .
    ...
    example "Graph-specific DELETE WHERE 1", :status => 'unverified', :w3c_status => 'unapproved' do
      ...
      repository = 'delete-where-dawg-delete-where-05'
      expected = [
          { 
