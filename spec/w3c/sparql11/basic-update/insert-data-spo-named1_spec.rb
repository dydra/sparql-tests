...
# http://www.w3.org/2001/sw/DataAccess/tests/r2#insert-data-spo-named1
#
...
INSERT DATA { GRAPH <http://example.org/g1> { :s :p :o } }
    ...
    example "Simple insert data named 1", :status => 'unverified', :w3c_status => 'unapproved' do
    
      graphs = {}
      graphs[:default] = nil


      repository = 'basic-update-insert-data-spo-named1'
      expected = [
          {
