...
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/delete-data/delete-data-02.ru
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-delete-data-02
#
...
DELETE DATA 
{
  GRAPH <http://example.org/g1> { :a foaf:knows :b }
    ...
    example "Simple DELETE DATA 2", :status => 'unverified', :w3c_status => 'unapproved' do
      ...
      repository = 'delete-data-dawg-delete-data-02'
      expected = [
          { 
