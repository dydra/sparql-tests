...
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/delete-data/delete-data-03.ru
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-delete-data-03
#
...
DELETE DATA 
{
  :a foaf:knows :c .
    ...
    example "Simple DELETE DATA 3", :status => 'unverified', :w3c_status => 'unapproved' do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'delete-data-dawg-delete-data-03'
      expected = [
          { 
