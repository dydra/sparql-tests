...
SELECT ?exam ?date { 
  ...
  FILTER NOT EXISTS {
    ...
    example "Medical, temporal proximity by exclusion (NOT EXISTS)", :tz => 'zulu', :w3c_status => 'unapproved' do
      ...
      expected = [
          { 
              :date => RDF::Literal.new('2010-01-10Z' , :datatype => RDF::URI('http://www.w3.org/2001/XMLSchema#date')),
