...
# STRLANG()
# 
# /Users/ben/Repos/datagraph/tests/tests/sparql11-tests/data-sparql11/functions/strlang01.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#strlang01
#
...
SELECT ?s (STRLANG(?str,"en-US") AS ?s2) WHERE {
    ...
    example "STRLANG()", :w3c_status => 'unapproved' do
      ...
      repository = 'functions-strlang01'
      expected = [
          { 
