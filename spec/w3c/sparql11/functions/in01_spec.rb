...
# IN 1
# 
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/functions/in01.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#in01
#
...
ASK {
    ...
    example "IN 1", :status => 'unverified', :w3c_status => 'unapproved' do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'functions-in01'
      expected = true
