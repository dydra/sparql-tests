...
# STRDT() TypeErrors
# 
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/functions/strdt03.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#strdt03
#
# This test is approved: 
#  20110717 jaa : string=>simple
#
...
SELECT ?s (STRDT(?o,xsd:string) AS ?str1) WHERE {
    ...
    example "STRDT() TypeErrors", :status => 'unverified', :w3c_status => 'unapproved', :string => 'simple' do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'functions-strdt03'
      expected = [
          { 
          ...
          { 
              ...
              :str1 => RDF::Literal.new('abc'),
          },
          { 
              :s => RDF::URI('http://example.org/s7'),
              :str1 => RDF::Literal.new('DEF'),
          },
          { 
