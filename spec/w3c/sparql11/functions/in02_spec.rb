...
# IN 2
# 
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/functions/in02.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#in02
#
...
ASK {
    ...
    example "IN 2", :status => 'unverified', :w3c_status => 'unapproved' do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'functions-in02'
      expected = false
