...
# STARTS()
# 
# /Users/ben/Repos/datagraph/tests/tests/sparql11-tests/data-sparql11/functions/starts01.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#starts01
#
...
SELECT ?s ?str WHERE {
    ...
    example "STARTS()", :w3c_status => 'unapproved' do
      ...
      repository = 'functions-starts01'
      expected = [
          { 
              :s => RDF::URI('http://example.org/n3'),
              :str => RDF::Literal.new('1.1' , :datatype => RDF::URI('http://www.w3.org/2001/XMLSchema#decimal')),
          },
          { 
