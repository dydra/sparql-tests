...
# DAY()
# 
# /Users/ben/Repos/datagraph/tests/tests/sparql11-tests/data-sparql11/functions/day-01.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#day
#
...
SELECT ?s (DAY(?date) AS ?x) WHERE {
    ...
    example "DAY()", :tz => 'zulu', :w3c_status => 'unapproved' do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'functions-day-zulu'
      expected = [
          { 
          ...
          { 
              ...
              :x => RDF::Literal.new('20' , :datatype => RDF::URI('http://www.w3.org/2001/XMLSchema#integer')),
          },
          { 
          ...
          { 
              ...
              :x => RDF::Literal.new('31' , :datatype => RDF::URI('http://www.w3.org/2001/XMLSchema#integer')),
          },
