...
# MONTH()
# 
# /Users/ben/Repos/datagraph/tests/tests/sparql11-tests/data-sparql11/functions/month-01.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#month
#
...
SELECT ?s (MONTH(?date) AS ?x) WHERE {
    ...
    example "MONTH(zulu)", :tz => 'zulu', :w3c_status => 'unapproved' do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'functions-month-zulu'
      expected = [
          { 
              :s => RDF::URI('http://example.org/d1'),
              :x => RDF::Literal.new('6' , :datatype => RDF::URI('http://www.w3.org/2001/XMLSchema#integer')),
          },
          { 
