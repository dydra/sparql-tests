...
SELECT ?s (STRLANG(?o,"en-US") AS ?str1) WHERE {
    ...
    example "STRLANG() TypeErrors simple", :status => 'unverified', :w3c_status => 'unapproved', :string => 'simple'  do
      ...
      expected = [
          ...
          },
          {
             ...
             :str1 => RDF::Literal.new('abc' , :language => 'en-us'),
          },
          {
             :s => RDF::URI('http://example.org/s7'),
             :str1 => RDF::Literal.new('DEF' , :language => 'en-us'), 
          },
          { 
