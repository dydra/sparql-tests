...
# MD5()
# 
# /Users/ben/Repos/datagraph/tests/tests/sparql11-tests/data-sparql11/functions/md5-01.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#md5-01
#
...
SELECT (MD5(?l) AS ?hash) WHERE {
    ...
    example "MD5()", :w3c_status => 'unapproved' do
      ...
      repository = 'functions-md5-01'
      expected = [
          { 
              :hash => RDF::Literal.new('acbd18db4cc2f85cedef654fccc4a4d8' ),
          },
      ]
