...
# MINUTES()
# 
# /Users/ben/Repos/datagraph/tests/tests/sparql11-tests/data-sparql11/functions/minutes-01.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#minutes
#
...
SELECT ?s (MINUTES(?date) AS ?x) WHERE {
    ...
    example "MINUTES()", :w3c_status => 'unapproved' do
      ...
      repository = 'functions-minutes'
      expected = [
          { 
              :s => RDF::URI('http://example.org/d1'),
              :x => RDF::Literal.new('28' , :datatype => RDF::URI('http://www.w3.org/2001/XMLSchema#integer')),
          },
          { 
              :s => RDF::URI('http://example.org/d2'),
              :x => RDF::Literal.new('38' , :datatype => RDF::URI('http://www.w3.org/2001/XMLSchema#integer')),
          },
          { 
              :s => RDF::URI('http://example.org/d3'),
              :x => RDF::Literal.new('59' , :datatype => RDF::URI('http://www.w3.org/2001/XMLSchema#integer')),
          },
          { 
