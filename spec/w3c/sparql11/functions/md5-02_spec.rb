...
# 
# /Users/ben/Repos/datagraph/tests/tests/sparql11-tests/data-sparql11/functions/md5-02.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#md5-02
#
...
SELECT (MD5(?l) AS ?hash) WHERE {
    ...
    example "MD5() over Unicode data", :w3c_status => 'unapproved' do
      ...
      repository = 'functions-md5-02'
      expected = [
          { 
              :hash => RDF::Literal.new('e7ada485d13b1decf628c9211bc3a97b' ),
          },
      ]
