...
# (pp35) Named Graph 2
# 
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/property-path/path-ng-02.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#pp35
#
...
where {
  ...
  FILTER (?g = <ng-01.ttl>)
    ...
    example "(pp35) Named Graph 2", :status => 'unverified' do
