...
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/delete/delete-01.ru
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-delete-01
#
...
WHERE
{
  ...
  ?s ?p ?o
    ...
    example "Simple DELETE 1", :status => 'unverified', :w3c_status => 'unapproved' do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'delete-dawg-delete-01'
      expected = [
          { 
