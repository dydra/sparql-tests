...
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/delete/delete-06.ru
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-delete-06
#
...
WHERE 
{
  GRAPH <http://example.org/g2> { ?s foaf:name "Chris" .
    ...
    example "Graph-specific DELETE 2", :status => 'unverified', :w3c_status => 'unapproved' do
      ...
      repository = 'delete-dawg-delete-06'
      expected = [
          { 
