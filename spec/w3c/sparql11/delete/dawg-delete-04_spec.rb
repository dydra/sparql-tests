...
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/delete/delete-04.ru
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-delete-04
#
...
WHERE
{
  GRAPH <http://example.org/g1> { ?s foaf:knows :c .
    ...
    example "Simple DELETE 4", :status => 'unverified', :w3c_status => 'unapproved' do
      ...
      repository = 'delete-dawg-delete-04'
      expected = [
          { 
