...
# This is a simple test to make sure the GRAPH clause overrides the USING clause
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/delete/delete-using-02.ru
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-delete-using-02
#
...
WHERE 
{
  GRAPH <http://example.org/g2> { :a foaf:knows ?s .
    ...
    example "Simple DELETE 2 (USING)", :w3c_status => 'unapproved' do
      ...
      repository = 'delete-dawg-delete-using-02'
      expected = [
          {
