...
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/delete/delete-with-01.ru
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#dawg-delete-with-01
#
...
WHERE
{
  ...
  ?s ?p ?o
    ...
    example "Simple DELETE 1 (WITH)", :status => 'unverified', :w3c_status => 'unapproved' do
      ...
      repository = 'delete-dawg-delete-with-01'
      expected = [
          { 
