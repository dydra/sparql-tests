...
# 
# /Users/ben/Repos/dydra/tests/tests/sparql11-tests/data-sparql11/entailment/rdfs13.rq
#
...
WHERE {
  ?L a rdfs:Literal
    ...
    example "RDFS inference test to show that newly introduced surrogate blank nodes are not to be returned in query answers", :w3c_status => 'unapproved' do
