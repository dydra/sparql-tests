...
# open-eq-10
# Test of '!='
# /Users/ben/repos/datagraph/tests/tests/data-r2/open-world/open-eq-10.rq
#
# This is a W3C test from the DAWG test suite:
# http://www.w3.org/2001/sw/DataAccess/tests/r2#open-eq-10
#
...
# 20110315 jaa: the blank nodes and the tag case were also issues
...
SELECT *
{
    ...
    example "open-eq-10", :blank_nodes => 'unique', :values => 'lexical', :status => 'bug' do
    
      graphs = {}
      graphs[:default] = { :data => @data, :format => :ttl}


      repository = 'open-world-open-eq-10'
      expected = [
          { 
